...
Celery.prototype.fetchOrders = function(order_status, payment_status, fulfillment_status, since) {
  return Q.promise(function(resolve, reject) {
    ...
    var orderQuery = 'orders' + (since ? since : '') + '&shipping_address.country=us' + '&order_status=' + (order_status ? order_status : 'open') + '&payment_status=' + (payment_status ? payment_status : 'paid') + '&fulfillment_status=' + (fulfillment_status ? fulfillment_status : 'unfulfilled');
